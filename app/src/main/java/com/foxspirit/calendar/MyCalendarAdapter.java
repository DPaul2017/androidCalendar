...
public class MyCalendarAdapter extends BaseAdapter {
    ...
    public MyCalendarAdapter(Context context, ArrayList<Integer> objects, String currentDate, int offset) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if ((Integer) getItem(position) != 0) textView.setText(getItem(position).toString());
